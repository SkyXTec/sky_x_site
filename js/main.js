...
(function () {
    ...
    if (menuToggle && navMenu) {
      ...
      document.addEventListener('click', (e) => {
        ...
        if (
          ...
          (isClickOutside || isClickOnOverlay)
        ) {
          navMenu.classList.remove('active');
          menuToggle.classList.remove('active');
          if (navOverlay) {
  ...
  function initGSAPAnimations() {
    if (typeof gsap === 'undefined') {
      ...
      document
        .querySelectorAll(
          '.scroll-fade-up, .scroll-fade-down, .scroll-fade-in, .scroll-scale-in',
        )
        .forEach((el) => {
          el.style.opacity = 1;
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
      ...
      console.error('✗ Button Effects:', e);
    }
    ...
    try {
      ...
      console.error('✗ Hero Button Glow:', e);
    }
